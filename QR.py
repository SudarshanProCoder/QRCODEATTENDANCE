...
class Qr_Generator:
    def __init__(self, root):
        ...
        self.root.title("QR Generator | Developed By Sudarshan Coder")
    ...
    def genrate(self):
        ...
        try:
            con = pymysql.connect(host="localhost", user="root", password="date@2004", database="student_data")
            cur = con.cursor()

            cur.execute("INSERT INTO student_data(rollNo, name, department, class, Phone_No, Alternate_No) VALUES(%s, %s, %s, %s, %s, %s)",
                    (
